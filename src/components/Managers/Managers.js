      ...
      {showModal &&
        <div className="modal">
          <div className="modal-content">
            ...
            <h2>Managers</h2>
            <p className="sub-title">Looking to make your life easier?<br/>
            Hire a manager to run your business for you! Don't miss out on the opportunity to boost your productivity and success.
            </p>
