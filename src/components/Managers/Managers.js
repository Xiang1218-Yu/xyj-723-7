...
import { hireManagerWithFunds } from '../../redux/actions';
...
export function Managers() {
  ...
  const available = !!objectToList(managers).find(
    (item) => item.price <= balance.amount && !item.hired
  );

  const hire = (manager) => {
    dispatch(hireManagerWithFunds(manager));
  };

  return (
    <div>
      <div
        className={'manager-btn' + (available ? ' active' : '')}
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <p className="sub-title">
              ...
              <br />
              Hire a manager to run your business for you! Don't miss out on the opportunity to
              boost your productivity and success.
            </p>
            <div className="manager-list">
              {objectToList(managers)
                ...
                .map((manager) => (
                  <div key={manager.businessId} className="manager">
                    ...
                    <button
                      disabled={manager.price > balance.amount}
                      onClick={() => {
                        hire(manager);
                      }}
                    >
